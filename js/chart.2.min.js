...
var chart, color1, qTable, qPrice_1, qPrice_2, qPrice_3, qPrice_4, qResponseDataRow1, qResponseDataRow2, qResponseDataRow3, qResponseDataRow4, datatable;

if (asset === "oil") {
	datatable = "https://www.google.com/fusiontables/DataSource?docid=1dDMPAWx1pgXvOjRujkwGjuaRYNPHb3mN3MTHEIU"
...
if (asset === "apple stock") {
	datatable = "https://www.google.com/fusiontables/DataSource?docid=1OcY8sHjn_UaUdXTCJlCDnhdjz3fid1qDt-aey1A"
	qTable = "1OcY8sHjn_UaUdXTCJlCDnhdjz3fid1qDt-aey1A";
	color1 = "#33CACA";	
	$('.usd.colorchart').css('color', color1);
	qPrice_1 = "appl_stock_USD";
	qResponseDataRow1 = 2;
	qPrice_2 = "appl_gold";
	qResponseDataRow2 = 3;
	qPrice_3 = "appl_hours";
	qResponseDataRow4 = 4;
	qPrice_4 = "appl_silver_100g";
	qResponseDataRow3 = 5;	
}

if (asset === "rice") {
	datatable = "https://www.google.com/fusiontables/DataSource?docid=1DhoV834TK92eKPqo6-YjrOxpEMdV9eZvLDyrVCY"
	qTable = "1DhoV834TK92eKPqo6-YjrOxpEMdV9eZvLDyrVCY";
	color1 = "#B8E62E";	
	$('.usd.colorchart').css('color', color1);
	qPrice_1 = "rice_USD";
	qResponseDataRow1 = 2;
...
if (asset === "rubber") {
	...
	qPrice_1 = "rubber_USD";
	qResponseDataRow1 = 6;
	qPrice_2 = "rubber_gold";
	qResponseDataRow2 = 7;
	qPrice_3 = "rubber_hours";	
	qResponseDataRow4 = 8;
	qPrice_4 = "rubber_silver";
	qResponseDataRow3 = 9;	
}

if (asset === "cotton") {
	datatable = "https://www.google.com/fusiontables/DataSource?docid=1JtOKsCXmdg7DyVNVuQywW_xWKs_oy01uXWA5vLU"
	qTable = "1JtOKsCXmdg7DyVNVuQywW_xWKs_oy01uXWA5vLU";
	color1 = "#B28FB2";	
	$('.usd.colorchart').css('color', color1);
	qPrice_1 = "Cotton_USD";
	qResponseDataRow1 = 2;
	qPrice_2 = "Cotton_gold";
	qResponseDataRow2 = 3;
	qPrice_3 = "Cotton_silver";	
	qResponseDataRow4 = 4;
	qPrice_4 = "Cotton_hours";
	qResponseDataRow3 = 5;	
}
...
if (asset === "shrimp") {
	...
	qPrice_1 = "Shrimp_USD";
	qResponseDataRow1 = 6;
	qPrice_2 = "Shrimp_gold";
	qResponseDataRow2 = 7;
	qPrice_3 = "Shrimp_silver";	
	qResponseDataRow4 = 8;
	qPrice_4 = "Shrimp_hours";
	qResponseDataRow3 = 9;	
}
...
if (asset === "sugar") {
	...
	qPrice_2 = "Sugar_gold";
	qResponseDataRow2 = 11;
	qPrice_3 = "Sugar_silver";	
	qResponseDataRow3 = 12;
	qPrice_4 = "Sugar_hours";
	qResponseDataRow4 = 13;	
}



//set datasrouce for download data
$('#datatable').attr('href', datatable);
